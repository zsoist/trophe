...
export const translations: Record<string, Record<CoreLanguage, string>> = {
  ...
  'workout.atlas_region_label': { en: '{muscle}, {role} muscle', es: '{muscle}, músculo {role}', el: '{muscle}, {role} μυς' },
  'workout.atlas_more_highlighted': { en: '+{n} more highlighted', es: '+{n} más destacados', el: '+{n} ακόμη τονισμένοι' },
  'workout.atlas_role_primary': { en: 'Primary', es: 'Principal', el: 'Κύριος' },
  'workout.atlas_role_secondary': { en: 'Secondary', es: 'Secundario', el: 'Δευτερεύων' },
  'workout.atlas_role_stabilizer': { en: 'Stabilizer', es: 'Estabilizador', el: 'Σταθεροποιητής' },
