...
export const translations: Record<string, Record<CoreLanguage, string>> = {
  ...
  'workout.atlas_summary': { en: '{view} anatomy: {count} highlighted muscle roles.', es: 'Anatomía {view}: {count} funciones musculares destacadas.', el: 'Ανατομία {view}: {count} τονισμένοι μυϊκοί ρόλοι.' },
  ...
  'workout.atlas_deep_marker': { en: 'Deep', es: 'Profundo', el: 'Βαθύ' },
  'workout.atlas_deep_guide_detail': { en: '{muscle} is shown as a deep location guide, not a precise surface contour.', es: '{muscle} se muestra como guía de ubicación profunda, no como un contorno superficial preciso.', el: 'Ο {muscle} εμφανίζεται ως οδηγός βαθιάς θέσης, όχι ως ακριβές επιφανειακό περίγραμμα.' },
