...
export const translations: Record<string, Record<CoreLanguage, string>> = {
  ...
  'workout.picker_choose_area_hint': { en: 'Choose a body area to see relevant exercises.', es: 'Elige una zona del cuerpo para ver ejercicios relevantes.', el: 'Επίλεξε περιοχή του σώματος για να δεις τις κατάλληλες ασκήσεις.' },
  'workout.picker_options': { en: '{n} options', es: '{n} opciones', el: '{n} επιλογές' },
  'workout.picker_back_areas': { en: 'Back to body areas', es: 'Volver a zonas del cuerpo', el: 'Πίσω στις περιοχές σώματος' },
