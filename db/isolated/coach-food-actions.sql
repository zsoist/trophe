...
CREATE TABLE private.coach_food_entry_versions (
  entry_id uuid PRIMARY KEY REFERENCES public.food_log(id) ON DELETE CASCADE,
...
CREATE TRIGGER coach_food_entry_revision AFTER INSERT OR UPDATE ON public.food_log
