...
def main():
    ...
    dispatch['incline_elbow_hinge']=incline_refine.elbow_hinge
    ...
    dispatch['incline_constraints']=incline_refine.constraint_audit
    dispatch['incline_refine_motion']=incline_refine.motion
    dispatch['incline_refine_garment']=incline_refine.garment
    dispatch['incline']=incline.run
    dispatch['incline_stabilize']=incline.stabilize
    dispatch['incline_review']=incline.review
