...
9b. NUTRIENT FACTS ARE NOT FOOD WEIGHT (CRITICAL): a gram value next to a
    nutrient name describes that nutrient's total in the item. It does NOT
    describe how much the food weighs.
    - "protein bar with 13 g protein" → 1 protein bar/piece with a normal bar
      weight (typically 50-70g). NEVER quantity=13/unit=g.
    - "this bar has 20g carbs and 7g fat" → 1 bar/piece. The stated numbers are
      label totals, not portion measurements.
    - "60g protein bar with 13g protein" → the bar weighs 60g and contains 13g
      protein. Only the first 60g is the portion measurement.
    - The same rule applies to proteína/protéines/πρωτεΐνη, carbohydrates,
      fat, fiber, sugar, and calories in every supported language.
...
| Beef steak, grilled/cooked | 210 | 27.0 | 0 | 10.0 |

CRITICAL BEEF DISTINCTION:
- Generic "steak", "beef steak", or "grilled steak" means a whole cooked beef steak.
- NEVER use the 80/20 ground-beef row (17.2g protein/100g) for steak. Ground beef applies only when the user explicitly says ground, minced, burger, or patty.
- For generic cooked steak, use approximately 25-30g protein per 100g. Preserve an explicit gram amount exactly.
...
- 1 regular serving carne asada / grilled steak = 150-170g; a large/big whole steak = 200g
- Explicit steak grams are exact: preserve "100g steak" as 100g, "250g steak" as 250g, and so on
