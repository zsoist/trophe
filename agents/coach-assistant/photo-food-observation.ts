...
export interface PhotoFoodObservation extends PhotoFoodScope {id:string;revision:string;imageDigest:string;source:'validated_photo_analysis'|'offline_fixture';foods:PhotoAnalysisFood[];items:ParsedFoodItem[]}
