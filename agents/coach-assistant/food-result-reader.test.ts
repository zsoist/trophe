...
const values={loggedDate:'2024-02-29',foodName:'Rice',foodId:null,source:'natural_language',sourceId:'turn:fixture',grams:10,quantity:1,calories:20,proteinG:1,carbsG:2,fatG:0,fiberG:null,sugarG:null};
const base={version:'coach-assistant.v2',storage:'database'};
const fixtures=[{...base,ok:false,error:'forbidden'}, {...base,ok:true,snapshot:{...values,entryId:id,version:'1'}}, {...base,ok:true,proposal:{id,hash:'a'.repeat(64),action:'food.quantity.update',resource:{kind:'food_entry',id,version:'1'},before:values,after:{...values,grams:20},expectedVersion:'1',precondition:'1',expiresAt:'2024-02-29T12:30:00+05:30',reviewRequired:true}}, {...base,ok:true,receipt:{id,actionId:id,proposalId:id,status:'applied',resourceVersion:'2',recordedAt:'2024-02-29T12:30:00Z'},refresh:{entryId:id,loggedDate:'2024-02-29',previousVersion:'1',version:'2',strategy:'refetch'},change:{beforeGrams:10,afterGrams:20}}];
