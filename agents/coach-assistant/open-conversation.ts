...
const candidatePersonalClaimPattern=/\byou (?:are|were|have|did|completed|ate|trained)\b|\byour\b[^.!?]*\b(?:is|are|was|were|has|have|show|indicate|prove)\b|\btus?\b[^.!?]*\b(?:es|son|esta|estan|fue|fueron|tiene|tienen|demuestra\w*|indica\w*)\b|\btienes\b[^.!?]{0,120}\bsaludables?\b/i;
