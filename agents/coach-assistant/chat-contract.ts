...
export interface CoachChatTurnRecovery {thread:CoachChatThread;turnId:string;status:'settled'|'inflight'|'failed';user:CoachChatMessage;assistant:CoachChatMessage|null}
