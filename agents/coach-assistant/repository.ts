...
export interface PersonalContextRow {
  userId: string; memoryContextVersion?:string; foodPreference?:import('./food-preference-contracts').FoodPreferenceSnapshot; preferences: unknown; preferencesVersion?:string; memoriesRead?:boolean;
