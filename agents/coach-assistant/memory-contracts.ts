...
export const persistentMemoryCardSchema=z.object({id:uuid,text,createdAt:z.string().datetime({offset:true}),version:revision,confirmation:z.literal('confirmed'),source:z.literal('user_input'),retention:z.literal('persistent'),conversationId:uuid}).strict();
...
export const persistentMemoryResultSchema=z.union([
 ...
 z.object({...common,ok:z.literal(true),memories:z.array(persistentMemoryCardSchema).max(20),scopeRevision:revision,derivedContext:z.literal('excluded')}).strict(),
