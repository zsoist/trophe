...
const item=object({index:integer(0,7),version:hash,foodName:stringLength(1,200),estimatedGrams:finite(Number.MIN_VALUE,Number.MAX_VALUE),estimatedCalories:finite(0,Number.MAX_VALUE),confidence:finite(0,.75),accuracyNote:stringLength(0,500),identityStatus:enumeration(['identified','uncertain','unassessed'])},['identityStatus']);
