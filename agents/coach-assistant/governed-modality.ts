...
const contracts:Record<ModalityTask,TaskContract>={
 photo_analyze:{provider:'openai',model:LUNA_MODEL,promptVersion:'photo-analyze-v3',pricingVersion:PHOTO_PILOT_PRICING_VERSION,reservationNanoUsd:PHOTO_ATTEMPT_RESERVATION_NANO_USD},
