...
const harness = vi.hoisted(() => ({ discardDraft: vi.fn(), push: vi.fn(), getUser: vi.fn() }));
...
vi.mock('@/components/workout/workspace/WorkoutWorkspaceProvider', () => ({ useWorkoutWorkspace: () => ({ state: { stage: 'review', draft }, discardDraft: harness.discardDraft }) }));
