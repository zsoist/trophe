...
| Workout Home / plan / editor | Same controller, authorized summaries; reviewed preferences | Draft proposal core and guarded workspace refresh boundary integrated locally; full draft review UI still pending. No automatic start or logging |
...
| Image UI verification | Local previews and honest unavailable-analysis labels | 390px empty Photos panel inspected. Actual file selection/removal visual test pending: native Codex app control was rejected by Computer Use; no workaround attempted |
