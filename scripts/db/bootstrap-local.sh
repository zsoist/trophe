...
INSERT INTO foods (
  ...
  ('usda', 'wp2-seed-ground-beef-cooked', 'lab_verified', 'Ground beef, 80% lean, 20% fat, cooked, pan-browned', ARRAY['US','CO'],
   ...
   'USDA SR reference values; deterministic local/CI bootstrap fixture (not production data).', now(), 85, 'manual'),
  ('cofid', 'wp2-seed-sirloin-steak-grilled', 'lab_verified', 'Beef, sirloin steak, grilled medium-rare, lean and fat', ARRAY['US','CO','GR'],
   213, 24.8, 0.0, 12.6, 0.0, 200, 'piece', 0.95, true, 'beef_sirloin_steak_grilled',
   'CoFID 18-071 reference values; deterministic local/CI bootstrap mirror of the production lab record.', now(), 90, 'manual'),
